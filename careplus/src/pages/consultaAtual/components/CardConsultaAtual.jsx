...
export default function CardConsultaAtual({
  ...
  const saveObservacoes = async () => {
    try {
      await realizarAnotacoes(idConsulta, anotacoes)
  ...
  return (
    <div className="flex w-full items-center justify-center bg-white rounded-[10px] sm:w-[50vw]">
      ...
      <ConfirmacaoModal
        ...
        onConfirm={saveObservacoes}
        titulo="Salvar Observações"
        mensagem="Tem certeza que deseja salvar as observações desta consulta?"
